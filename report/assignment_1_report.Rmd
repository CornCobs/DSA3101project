...
2. Imputation using regression imputer
Pros:
Regression imputer may reduce bias of the dataset.
We know that it will not introduce any additional assumptions.

Cons:
It may be difficult to accomplish as we do not have much experience in it.
...
![FIgure name (preMCO)](../images/preMCOHIHM.jpeg)
![FIgure name (preMCO)](../images/postMCOHIHM.jpeg)
![FIgure name (preMCO)](../images/preMCOHILM.jpeg)
![FIgure name (preMCO)](../images/postMCOHILM.jpeg)
...
#Send the customers whose RFM score changes from either 331 to 332 or 331 to 333 or 332 to 333 a thank you note for being a good customer and give them a discount voucher to reward and encourage their good customer behaviour. 
